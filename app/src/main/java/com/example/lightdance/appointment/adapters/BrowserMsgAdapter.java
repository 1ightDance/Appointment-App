...
//            place        = (TextView) itemView.findViewById(R.id.tv_appointment_place);
     ...
     * 然后就可以通过设置OnClickListener接口，即setOnclickListener方法为两个监听器设置具体的监听逻辑（实现onClick()方法）
     ...
     * adapter把自己的接口给BrowserFragment-->BrowserFragment帮adapter把接口实现好还给adapter-->adapter知道了被点击会发生什么
